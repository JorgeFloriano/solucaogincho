...
<body>
        ...
        <main class="form-wrapper">
            ...
            <form action="{{ route('orcamento.calcular') }}" method="POST" class="quotation-form" id="gui-form">
                ...
                <div class="input-group">
                    ...
                    <input type="text" id="name" name="name" autocomplete="name" placeholder="Ex: João da Silva"
                        value="{{ old('name') }}" required>
                </div>

                <div class="input-group">
                    <label for="phone">Seu Telefone / WhatsApp</label>
                    <input type="tel" id="phone" name="phone" autocomplete="tel" placeholder="Ex: (15) 99999-9999"
                ...
                <div class="input-group">
                    <div style="display: flex; justify-content: space-between; align-items: baseline;">
                        ...
                        <button type="button" id="btn-gps"
                            style="background: none; border: none; padding: 0; color: #3b82f6; cursor: pointer; font-size: 0.85rem; font-weight: 600; display: flex; align-items: center; gap: 0.25rem;">
                ...
                <div class="input-group">
                    ...
                    <select id="vehicle_type" name="vehicle_type" required>
                        <option value="" disabled {{ old('vehicle_type') ? '' : 'selected' }}>Selecione o veículo...
                        </option>
                        <option value="carro" {{ old('vehicle_type') == 'carro' ? 'selected' : '' }}>Carro de Passeio
                        </option>
                ...
                <div class="conditions-grid">
                    ...
                    <label class="checkbox-card" id="van-condition"
                        style="display: {{ in_array(old('vehicle_type'), ['van', 'caminhonete']) ? 'flex' : 'none' }};">
    ...
    <script>
        ...
        // Máscara para o campo de telefone (XX) XXXXX-XXXX ou (XX) XXXX-XXXX
        document.getElementById('phone').addEventListener('input', function (e) {
            let value = e.target.value.replace(/\D/g, ''); // Remove tudo que não for número

            // Remove o "55" se ele estiver no início e o número for longo o suficiente
            // (Geralmente checamos se tem mais de 10 dígitos para não apagar o DDD 55)
    ...
    <script async
        src="https://maps.googleapis.com/maps/api/js?key={{ env('GOOGLE_MAPS_API_KEY') }}&libraries=places&loading=async&callback=initMap"></script>
</body>
